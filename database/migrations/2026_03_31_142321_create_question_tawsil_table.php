...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('question_tawsil', function (Blueprint $table) {
            ...
            $table->string('link_option_1', 255);
            $table->string('option_2', 255);
            $table->string('link_option_2', 255);
            $table->string('option_3', 255);
            $table->string('link_option_3', 255);
            $table->string('option_4', 255);
            $table->string('link_option_4', 255);
            $table->string('option_5', 255);
            $table->string('link_option_5', 255);
            $table->string('option_6', 255);
            $table->string('link_option_6', 255);
