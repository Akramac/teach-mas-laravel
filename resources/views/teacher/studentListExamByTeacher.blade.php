                ...
                <div class="col-md-9 col-xs-12">
                    ...
                    <div class="sort-bar clearfix">
                        <div class="sort-options pull-right">
                            <span class="hidden-xs">List of Exams </span>
                            <!--Grid-list view-->
                        ...
                        <div class="col-md-12 ">
                            ...
                            <article data-page="{{ ($exam->id % 5) + 1 }}"  >
                                <div class="info">
                                    ...
                                    <?php
                                    $hash='';
                                    foreach($arrayLinksByExam as $k => $link){
                                        if($k==$exam->id){
                                            $hash=$arrayLinksByExam[$k]->hash;
                                        }}?>
                                    <?php if($hash!=''){?>
                                    <span>
                                        <a  class="btn btn-copy" data-clipboard-target="#url-to-be-copied-{{$hash}}" data-title="Copy Link"><i class="fa fa-link" aria-hidden="true"></i></a>
                                    </span>
                                    <p  id="url-to-be-copied-{{$hash}}" style="color:blue;opacity:0;" >index.php/student/activate-exam/{{$exam->id}}/{{$exam->teacher_id}}/{{$hash}}</p>
                                    <?php } ?>
                                </div>
